...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="../css/vendor/jquery.jscrollpane.css"/>
    <!-- second the general css -->
    <link rel="stylesheet" type="text/css" href="../css/blam.css"/>
    <!-- last the page specific css -->
    <link rel="stylesheet" type="text/css" href="css/crud.css"/>
    <!-- first all the libraries, jquery first is needed for the rest -->

    <script type="text/javascript" src="../js/vendor/jquery.js">
    </script>
    <script type="text/javascript" src="../js/vendor/jquery-ui.js">
    </script>
    <script type="text/javascript" src="../js/vendor/jquery.jscrollpane.min.js">
    </script>
    <script type="text/javascript" src="../js/vendor/jquery.mousewheel.js">
    </script>
    <script type="text/javascript" src="../js/vendor/mwheelIntent.js">
    </script>
    <!-- general javascript -->
