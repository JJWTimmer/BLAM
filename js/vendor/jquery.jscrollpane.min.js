...
(function (b, a, c) {
    b.fn.jScrollPane = function (f) {
        function d(D, N) {
            var ay, P = this, X, aj, w, al, S, Y, z, r, az, aE, au, j, I, i, k, Z, T, ap, W, u, B, aq, ae, am, G, m, at, ax, y, av, aI, g, K, ai = true, O = true, aH = false, l = false, ao = D.clone().empty(), ab = b.fn.mwheelIntent ? "mwheelIntent.jsp" : "mousewheel.jsp";
            ...
            function ar(aR) {
                ...
                if (X === c) {
                    ...
                    w = D.innerHeight();
                    D.width(aj);
                    X = b('<div class="jspPane" />').css("padding", aI).append(D.children());
                    al = b('<div class="jspContainer" />').css({width: aj + "px", height: w + "px"}).append(X).appendTo(D)
                } else {
                    D.css("width", "");
                    aK = D.innerWidth() + g != aj || D.outerHeight() != w;
                    if (aK) {
                        aj = D.innerWidth() + g;
                        w = D.innerHeight();
                        al.css({width: aj + "px", height: w + "px"})
                    }
                    if (!aK && K == S && X.outerHeight() == Y) {
                        D.width(aj);
                        return
                    }
                    K = S;
                ...
                aP = X.clone().css("position", "absolute");
                aQ = b('<div style="width:1px; position: relative;" />').append(aP);
                b("body").append(aQ);
                S = Math.max(X.outerWidth(), aP.outerWidth());
                aQ.remove();
                Y = X.outerHeight();
                z = S / aj;
                r = Y / w;
                ...
                aJ && D.scrollTop(0) && L(aJ, false);
                aO && D.scrollLeft(0) && M(aO, false);
            ...
            function aF() {
                if (az) {
                    ...
                    au.hover(function () {
                        ...
                        var s = aJ.pageY - au.position().top;
            ...
            function F() {
                if (aE && az) {
                    var aJ = G.outerHeight(), s = ap.outerWidth();
                    u -= aJ;
            ...
            function H(aM, aL, aP, aO) {
                ...
                var aN, aK, aJ = true, s = function () {
                    if (aM !== 0) {
                        P.scrollByX(aM * ay.arrowButtonSpeed)
                    }
                    if (aL !== 0) {
                        P.scrollByY(aL * ay.arrowButtonSpeed)
                    }
                    aK = setTimeout(s, aJ ? ay.initialDelay : ay.arrowRepeatFreq);
                    aJ = false
                };
                s();
            ...
            function q() {
                x();
                if (az) {
                    ap.bind("mousedown.jsp", function (aO) {
                        if (aO.originalTarget === c || aO.originalTarget == aO.currentTarget) {
                            var aM = b(this), aP = aM.offset(), aN = aO.pageY - aP.top - I, aK, aJ = true, s = function () {
                                var aS = aM.offset(), aT = aO.pageY - aS.top - B / 2, aQ = w * ay.scrollPagePercent, aR = j * aQ / (Y - w);
                                if (aN < 0) {
                                    if (I - aR > aT) {
                                        P.scrollByY(-aQ)
                                    } else {
                                ...
                                aK = setTimeout(s, aJ ? ay.initialDelay : ay.trackClickRepeatFreq);
                                aJ = false
                            }, aL = function () {
                                aK && clearTimeout(aK);
                                aK = null;
                ...
                if (aE) {
                    G.bind("mousedown.jsp", function (aO) {
                        if (aO.originalTarget === c || aO.originalTarget == aO.currentTarget) {
                            var aM = b(this), aP = aM.offset(), aN = aO.pageX - aP.left - Z, aK, aJ = true, s = function () {
                                var aS = aM.offset(), aT = aO.pageX - aS.left - at / 2, aQ = aj * ay.scrollPagePercent, aR = k * aQ / (S - aj);
                                if (aN < 0) {
                                    if (Z - aR > aT) {
                                        P.scrollByX(-aQ)
                                    } else {
            ...
            function ac(aJ) {
                ...
                al.scrollTop(0);
                I = aJ;
                var aM = I === 0, aK = I == j, aL = aJ / j, s = -aL * (Y - w);
                if (ai != aM || aH != aK) {
                    ai = aM;
                    aH = aK;
                    D.trigger("jsp-arrow-change", [ai, aH, O, l])
                }
                v(aM, aK);
                X.css("top", s);
            ...
            function ad(aJ) {
                ...
                al.scrollTop(0);
                Z = aJ;
                var aM = Z === 0, aL = Z == k, aK = aJ / k, s = -aK * (S - aj);
                if (O != aM || l != aL) {
                    O = aM;
                    l = aL;
                    D.trigger("jsp-arrow-change", [ai, aH, O, l])
            ...
            function v(aJ, s) {
                if (ay.showArrows) {
                    aq[aJ ? "addClass" : "removeClass"]("jspDisabled");
            ...
            function t(aJ, s) {
                if (ay.showArrows) {
                    ax[aJ ? "addClass" : "removeClass"]("jspDisabled");
            ...
            function aa(aV, aQ, aK) {
                var aO, aL, aM, s = 0, aU = 0, aJ, aP, aS, aR, aT;
                try {
                    aO = b(aV)
                } catch (aN) {
                    return
                ...
                viewportLeft = aC();
                aS = viewportLeft + aj;
                if (aU < viewportLeft || aQ) {
                    aT = aU - ay.horizontalGutter
                } else {
                    if (aU + aM > aS) {
                        aT = aU - aj + aM + ay.horizontalGutter
                    }
                }
                if (aT) {
                    M(aT, aK)
            ...
            function af() {
                al.unbind(ab).bind(ab, function (aM, aN, aL, aJ) {
                    var aK = Z, s = I;
                    P.scrollBy(aL * ay.mouseWheelSpeed, -aJ * ay.mouseWheelSpeed, false);
                    return aK == Z && s == I
                })
            }
            ...
            function C() {
                if (location.hash && location.hash.length > 1) {
                    ...
                    if (aK.length && X.find(location.hash)) {
                        if (al.scrollTop() === 0) {
            ...
            function n() {
                ...
                b("a[href^=#]").addClass("jspHijack").bind("click.jsp-hijack", function () {
                    ...
                    if (s.length > 1) {
                        aJ = s[1];
                        if (aJ.length > 0 && X.find("#" + aJ).length > 0) {
                            aa("#" + aJ, true);
                            return false
                        }
                    }
            ...
            function an() {
                ...
                al.unbind("touchstart.jsp touchmove.jsp touchend.jsp click.jsp-touchclick").bind("touchstart.jsp",function (aO) {
                    ...
                    var aQ = aR.originalEvent.touches[0], aP = Z, aO = I;
            ...
            b.extend(P, {reinitialise: function (aJ) {
                aJ = b.extend({}, ay, aJ);
                ar(aJ)
                ...
                var aJ = aC() + s, aL = aJ / (S - aj);
                V(aL * k, aK)
            }, scrollByY: function (s, aK) {
                var aJ = aA() + s, aL = aJ / (Y - w);
                U(aL * j, aK)
                ...
                var aK = {};
                aK[aM] = s;
                aJ.animate(aK, {duration: ay.animateDuration, ease: ay.animateEase, queue: false, step: aL})
