function Ticket(pane, status, reverse) {
    ...
    this.fillTicket = function (selectElement, ticket_id, parent_id) {
        ...
        if (parent_id == 0) {
            become_Ticket_options[become_Ticket_options.length] = new Option('-----Open-----', 0);
        }
        $.tzPOST('getTicketList', {timestamp_last_update:'all', recursive:false, status:[
            {1:'Open'}
        ]}, function (r) {
            if (r) {
                if (!r.error) {
            ...
            if (parent_id == 0) {
                become_Ticket_options[become_Ticket_options.length] = new Option('-----Nieuw-----', 0);
            }
            ...
            $.tzPOST('getTicketList', {timestamp_last_update:'all', recursive:false, status:[
                ...
                if (parent_id == 0) {
                    become_Ticket_options[become_Ticket_options.length] = new Option('---Gesloten----', 0);
                }
